...
# for i in range(len(ds['train']['Question'])):
  with torch.no_grad():
    for row in range(split):
        ...
        docs = retriever.invoke('An astronomer observes that a planet rotates faster after a meteorite impact. Which is the most likely effect of this increase in rotation')
